...
const rightGrid = [
  ...
  const bottomThree = [
  { id: 0, title: "ACOLYTES", text: "ACOLYTES are males from the age of 19. All men are acolytes to the Priesthood of Melchizedek. It takes a year to train an acolyte and during that time they are taught how to drive and maintain a kharvee and how to do their first jobs. Women that commit crimes are also inducted as acolytes to the priesthood as labour.  "},
