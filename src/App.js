...
function WorldRule2Page() {
  ...
  { id: 3, title: "Palatines and Mac", text:"Palatines are women of the NIFTYER59HALO family. They can be wives, daughters, or women who went to college. There are 23,976 Palatines. The Palatines are responsible for the Macs, who receive the instructions and trade goods between the Palatines. There are 12 Macs per town. Palatines ensure that each town manufactures, produces, and constructs as requested, and they handle the trade of their CLT. They form a governing body with the Emir, Proedros, Bishop, and Amira of their CLT." },
  { id: 4, title: "Proedros and Emir ", text:" Proedros are children of NIFTYER59HALO who  are in charge of an Emporium and run it as an independent city state focuses on commerce. They are allowed to employ men and women that have performed well on the 89 test who become Polites. Emirs rule the Emirate."},
