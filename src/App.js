...
const rightGrid = [
  ...
  const bottomThree = [
  { id: 0, title: "ACOLYTES and the MSHN", text: "ACOLYTES are males from the age of 19. All men are acolytes to the Priesthood of Melchizedek. It takes a year to train an acolyte and during that time they are taught how to drive and maintain a kharvee and how to do their first jobs. Women that commit crimes are also inducted as acolytes to the priesthood as labour. Acolytes are required to maintain fitness and there is an execise bike inside the Kharvee. The goal for all male acolytes is to complete the MSHN. "},
  ...
  { id: 2, title: "THE LABIA AND PMSEC", text:"The Labia is the route that runs along the outside of a CLIT. Along this route are all the eshtions, services and utilities available to men. Men are expected to work at their destination and along the route they aquire extra points for performing research(optional). Men who do not do research do not have sex. PMSEC stands for produce, manufacturing, services, entertainment and construction. It is the typical category for a civilian of the world empire. The goal is to MSHN. Which is to learn and teach the most skilled jobs as a MAGGOT, SKOULIKIA and HATI and then to novelise. Novelise is to innovate something new, write a research paper, write a fiction novel and a separate play or film script. Once these goals have been completed a male is ellgibile to have sex. " },
...
const mainCards = [
  ...
  },
  {
    ...
    subCards: [
      ...
      { id: 33, text: "Sex is a reward for men that work 4 jobs at the highest level and have completed teaching 4 jobs at the highest level (44). They must also have produced something useful in the Labia worthy of merit and production value. On attainment of these goals they are permitted to enter a given town with an electronic condom to have sex with any woman willing, although not any woman of rank such as ladies. From then they must maintain productivity and will be able to have sex thrice a year on Christmas, Easter and the anniversary of when first given their condom.", image: "/images/icon2.png" },
