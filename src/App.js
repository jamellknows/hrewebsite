...
useEffect(() => {
  ...
  const accordionItems = [
  {
    ...
    content: "Marriage is a right of priests, polītai, and members of NIFTYER59HALO. Marriage partners for priests and polītai are found using a dating app. Women that live in the towns are free to have sex with the boys from age 16 to 18(when they leave). When males leave they are given a vasectomy, before that period thay are able to impregnate any woman of the town. Female acolytes aged 20 and above are free to have sex with well performing male acolytes at Palatinates if using protection. Men that are slaves do not have sex, but can donate sperm. The laws regarding sex for Polītai are mostly governed by the Proedros of that Polis, however some laws will still be in effect and sperm donation is required to start a family."
  },
  {
    id: 1,
...
function DualCarouselCards() {
  ...
  const carousels = {
    one: [
      ...
      { title: "Acolyte", text: "Acolytes are the average man who dedicates their life to the Oikos of the Oikodrome and the EPIC MSHN. During a males life he is guaranteed to become an acolyte. Initiation begins at the age of 18 whereby a man is given a vasectomy after a sperm donation session. ", img: "/images/classes/acolyte.png" },
