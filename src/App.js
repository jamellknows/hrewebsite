...
const cosmology = [
  ...
  },
  {
    ...
    children: [
     {
    title: "Boeing",
    description: "Bezalel, son of Uri and grandson of Hur of the tribe of Judah and Oholiab, son of Ahisamach, of the tribe of Dan and Elijah the Tishbite from Tishbe (Gilead: East of the Jordan River)(Of Gad most likely).",
...
function DualCarouselCards() {
  ...
  const carousels = {
    ...
    two: [
      ...
      { title: "Exiles", text:"Exile women are those that had sex before the age of 20 and have been paired for life with the male they had sex with to live in a motorbike for 6 years before living in a kharvee together, they are unable to progress above acolyte unless recruited to be a Polítēs with their partner. This rule also applies to female acolytes who have sex before 20. If her partner progresses to Sexton she is not counted as one of his three wives.", img: "/images/classes/exile.png" },
