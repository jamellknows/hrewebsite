...
const mainCards = [
  {
    ...
    subCards: [
      ...
      { id: 13, text: "A daughter is a category consisting of two types of women. The first are the biological daughters of myself, Russell or Kwame that live in the hidalgo with the evangellions. The second are the children of townies who have been fertilised with the semen of a slave. They raise the child in the town and then when thr child turns 18 they are moved to the hidalgo to be friends with my biological daughters. There they are celebrities of some form I will work it out. ", image: "/images/daughters.png" },
