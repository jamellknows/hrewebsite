    ...
    >
      ...
      >
        ...
        >
          ...
          to those within a town and a city girl has the option of refusing sexual intercourse. The more points a city girl accumulates promtes her higher up the ranks with rewards for studio decorations and clothing. Once decorations are aquired they remain, however access to clothing is recalculated every two years based on the number of points.
...
There are 331,068 priestesses worldwide, calculated as 3 priestesses per town. Each receives training within the College of her home RUS, where spiritual devotion is integrated with administrative discipline and leadership formation. While all priestesses may advance through the hierarchy, most aspire to reach the third rank, where leadership, governance, and direct institutional influence are most actively expressed.`
  ...
  { id: 6, title: "Rus", text:"The Rus is the Capital Town of a CLT and the administrative center. It is home to the frontier brains and is governed by the Synagogue of the Sefer. "},
  ...
  { id: 11, title: "Arx", text:"The Arx is the Bastion of a CLT and the logistics center simply put it is the gate.  It is governed by the Oikos of the Oikodrome and is home to the Elite 4."}, 
