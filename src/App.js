...
function DualCarouselCards() {
  ...
  const carousels = {
    one: [
      { title: "Klēros ", text: "Priests are men that have chosen to dedicate their lives to religion, study and research. New Klēroi are required to gain the highest marks in the 89 (top 0.1%). Priests work within the Rabt, the Oikos and the Synagogue.", img: "/images/classes/priest.png" },
