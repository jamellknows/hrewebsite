...
function WorldRule2Page() {
  ...
  { id: 1, title: "Ladies of the Lamp, Amiras of the Alpet, Infantas of the Impagliata", text:"These are the women who hold positions in the 9th Arm. Education for these can begin as young as 14 but they start between the ages 18 to 26. They must be a virgin. There are 389310 Ladies of the Lamp, 32832 Amiras of the Alper and 180 Infantas of the Impagliata." },
   {id: 2, title: "Priestess", text: "Priestess is the sacred title given to women between the ages of sixteen and twenty who serve within the Priesthood of Melchizedek at the Sanctuary of the Sea. The Sanctuary of the Sea houses the Social Services, which are divided into GSMS and Division Three. GSMS functions as the global platform for social media, communication, messaging, and entertainment. Division Three oversees GUM—Giving, Understanding, and Movement—ensuring the structured distribution of resources, coordination, and outreach. There are 23,328 Priestesses in total. They reside in temples and nunneries located outside the CLT, where they are supported by attendants and Evangelions who assist in managing their responsibilities and lands. Priestesses divide their service year into two equal parts. For one half of the year, they serve in a religious capacity—preaching, administering rites, and overseeing designated sacred sites. For the remaining half, they operate within the Social Services structure, contributing to governance, communication, and institutional administration. Above them stands the Divine Hiereia Megalē (ἹέρειαΜεγάλη) of the Sea, who governs all Priestesses within a CLT from the Thana, ensuring unity of doctrine, discipline, and direction."},  
  { id: 3, title: "Palatines and Mac", text:"Palatines are women of the NIFTY59ER family. They can be wives, daughters, or women who went to college. There are 23,976 Palatines. The Palatines are responsible for the Macs, who receive the instructions and trade goods between the Palatines. There are 12 Macs per town. Palatines ensure that each town manufactures, produces, and constructs as requested, and they handle the trade of their CLT. They form a governing body with the Emir, Proedros, Bishop, and Amira of their CLT." },
  { id: 4, title: "Proedros and Emir ", text:" Proedros are children of NIFTY59HALER who  are in charge of an Emporium and run it as an independent city state focuses on commerce. They are allowed to employ men and women that have performed well on the 89 test who become Polites. Emirs rule the Emirate."},
