...
function WorldRule2Page() {
  ...
  { id: 2, title: "Priestess", text:"Priestess is the title for the women (virgins 16 and 20) who work within The Priesthood of the Melchizedek for the Sanctuary of the Sea. The Sanctuary of the Sea contains the Social Services which is split between divisions of GSMS, and 3. GSMS is the global social media, calling, messaging and entertainment service. 3 run GUM, giving, understanding and movement. There are 23328 priestesses. Priestesses live in temples and nunneries outside of the CLT and also have slaves and evangelions to help them manage their tasks and their land. They split their time between running the Sanctuary of the Sea as a priestess who duties include preaching and overseeing certain religious sites half of the year and as members of the Social Services in the other half of the year." },
