  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <p style={{ fontSize: "15px", lineHeight: 1.6 }}>
            There are 20 princesses per city and 12 towns per city and the total number of princesses is 466560 worldwide. 
...
function WorldRule2Page() {
  ...
  const metric3 = [
  { id: 1, title: "Fashion", text:"Each city will have it's own fashion decided by the princesses in charge of that settlement. Fashion for the priestesses will be determined by themselves following some guidelines. Princesses do fashion for WESHGB KTSHAM, as there are 5 princesses per department each focuses on a season (there are 5 seasons in the new calendar) for all of the towns (12, 12 towns = 1 city). Priestesses do their own fashion. Queens can choose between princess fashion, priestess fashion or making their own clothes. The diversity is brought in by competing fashion brands from each of the 5 princesses which total to 116640 different fashion brands worldwide. This of course can be applied to virtually all parts of commerce. I am also including game development as a part of fashion. They have the help of acolytes who also "},
