...
The priesthood is organized into six distinct offices, arranged within a structured six-tier hierarchy. Advancement proceeds from Rank 1 to Rank 6, with Rank 6 representing the highest office and holding a seat on the Top7 Council.
...
- Rank 6 exercises senior authority and serves on the Top7 Council.
...
There are 331,068 priestesses worldwide. Each receives training within the College of her home RUS, where spiritual devotion is integrated with administrative discipline and leadership formation. While all priestesses may advance through the hierarchy, most aspire to reach the third rank, where leadership, governance, and direct institutional influence are most actively expressed.`
  ...
  { id: 4, title: "TOP 7", text:"The Top7 serves as the supreme governing body responsible for issuing directives and making all major decisions worldwide. Its membership is composed of the following leaders: Alvah or Russell, serving as the head and Priest of Melchizidek, representing the ruling NIFTYER59HALO family. Dao-shi-ni of the Temple of the Tao. Deva Desi of the Haveli of the Hari. Yeshe Tsoyal of the Cetiya of the Upasika. Mudarib al-Tahara of the Rabat of the Relics. Sacristan of the Oikos of the Oikodrom. Ba’alat Shem of the Synagogue of the Sefer. Thyiades of the Sanctuary of the Sea. The Top7 convenes for formal meetings once every 14 days, where they deliberate on global matters, issue guidance, and enforce the decisions of the council."},
  { id: 5, title: "Evangellions and Ivorgellions", text:"Evangellions and Ivorgellions are autonomous, AI-powered angelic beings, crafted from Lavore Luce (LL). They are designed to excel in all fundamental tasks while also mastering specialized disciplines. The hierarchy of these artificial angels is extensive: 10 Sefirot Angels — the most powerful and influential of their kind. 12 Archangels — responsible for advanced governance and strategic oversight. 10 Maimonides Angels — skilled in complex, specialized domains. 72 Ha-Shem Mephorah Angels — supporting a wide range of operational and mystical functions. All evangellions and ivorgellions operate using artificial intelligence developed by the supreme AI, Metatron, ensuring unmatched precision, learning capacity, and coordination across their spheres of influence." },
  { id: 6, title: "Zones", text:"Zones are the organizational framework used to determine where a person resides based on their results from 89 assessments. The zones are B8, B9, F8, F9, A9, and A8, with each zone governed with a specific rank of priesthood or nobility. B8 is giving and contient, B9 is language and understanding, F8 is movement and leadership, F9 is social and cause, A9 is service and justice and A8 (LAID) is completion(FEST). A person’s continental placement is determined by their best-performing result, reflecting their strongest skill or accomplishment in life: 18 – North Europe 42 – Middle East 32 – South Europe 11 – America, Africa, or Australia. 16 – South or East Asia. This system ensures that individuals are allocated to regions and social structures that best align with their demonstrated abilities and potential. An A9 is 3 FESTs (Shubs), An F9 is 7 Shubs (Rave), An F8 is 14 Raves (Panic) and a B9 is 11 Panics (Disco)."}
];
